...
(defun test-display-mode ()
  ...
  (let ((test-buffer (get-buffer-create "*test-migration*")))
    (with-current-buffer test-buffer
      ...
      (setq-local flyover-display-mode 'always) ; Reset
      ...
      (setq-local flyover-hide-when-cursor-is-on-same-line t)
      (setq-local flyover-display-mode 'always) ; Reset
      (flyover--migrate-display-settings)
      ...
      (setq-local flyover-hide-when-cursor-is-on-same-line nil)
      (setq-local flyover-hide-when-cursor-is-at-same-line t)
      (setq-local flyover-display-mode 'always) ; Reset
      (flyover--migrate-display-settings)
